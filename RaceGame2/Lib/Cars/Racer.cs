...
namespace RaceGame2.Lib.Cars
{
    public class Racer : Car
    {
        ...
        public Racer(int postionx, int positiony, float rotation, double speed, Keys leftKey, Keys rightKey, Keys throttleKey, Keys brakeKey, string carColour = "black", string imageLocation = "racer.png") : base(postionx, positiony, rotation, speed, leftKey, rightKey, throttleKey, brakeKey, carColour, imageLocation)
        {
        }
    }
}
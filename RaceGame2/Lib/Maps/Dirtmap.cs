...
namespace RaceGame2.Lib.Maps
{
    class DirtMap : Map
    {
        public DirtMap()
        {
            ...
            this.laps = 1;
            this.startingLine.Add(new Point(451, 288));
            this.startingLine.Add(new Point(451, 331));
            this.checkpoints.Add(new KeyValuePair<int, List<Point>>(1, new List<Point> { new Point(343, 287), new Point(423, 359) }));
